    ...
    <section class="slider-area tpslider-delay">
       <div class="swiper-container tp-slider6">
          <div class="swiper-wrapper">
                         ...
                         <div class="tpslider__five__wrapper pt-130 text-center">
                            ...
                            <div class="tpslider__five__contact">
                               ...
                               <div class="tpslider__five__btn">
                                  <a class="tp-btn" href="{{ route('products') }}">Shop Now</a>
                               </div>
                            </div>
                         </div>
                      </div>
             ...
             <div class="swiper-slide tpslider__bg6" data-background="{{ asset('assets/img/slider/p2.jpg') }}">
                <div class="container">
                   <div class="row">
                      <div class="col-lg-12">
                         <div class="tpslider__five__wrapper pt-130 text-center">
                   ...
                   <div class="row">
                      <div class="col-lg-12">
                         <div class="tpslider__five__wrapper pt-130 text-center">
                            ...
                            <div class="tpslider__five__contact">
                               <h3 class="tpslider__five__title mb-25">Fresh Grapes</h3>
                               <p>Our fresh Vietnamese vegetable rolls look taste even better.</p>
                               <div class="tpslider__five__btn">
                                 <a class="tp-btn" href="{{ route('products') }}">Shop Now</a>
                               </div>
                                  ...
                                  <div class="swiper-slide">
                                     <div class="tpproduct p-relative">
                                        <div class="tpproduct__thumb p-relative text-center">
                                           <a href="{{ route('product',$product->id) }}"><img src="{{ $product->img }}" alt="" height="100"></a>
                                           <a class="tpproduct__thumb-img" href="{{ route('product',$product->id) }}"><img src="{{ $product->img }}" alt=""></a>
          ...
          <div class="row">
             <div class="col-lg-12 text-center">
                <div class="tpsection mb-35">
                   <h4 class="tpsection__sub-title">~ International Products ~</h4>
                   <h4 class="tpsection__title">Find products outside your region</h4>
                </div>
             </div>
          </div>
          <div class="row">
                      ...
                      <div class="swiper-wrapper">
                        ...
                        @foreach($f_products as $product)
                         <div class="swiper-slide">
                            ...
                            <div class="tpproduct p-relative">
                               <div class="tpproduct__thumb p-relative text-center">
                                  <a href="{{ route('product',$product->id) }}"><img src="{{ $product->img }}" alt="" height="200"></a>
                                  <a class="tpproduct__thumb-img" href="{{ route('product',$product->id) }}"><img src="{{ $product->img }}"" alt="" height="220"></a>
