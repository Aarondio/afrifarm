                                                            ...
                                                            @if (isset(Auth::user()->id))
                                                                ...
                                                                @if (empty($cart))
                                                                    <form action="{{ route('addToCart') }}" method="POST">
                                                                        ...
                                                                        <button
                                                                            class="btn btn-success rounded-pill p-2 px-5">Add
                                                                            to Cart</button>
                                                                ...
                                                                @else
                                                                    <div
                                                                        ...
                                                                        <form action="{{ route('cartminus') }}"
                                                                            ...
                                                                            <button type="submit"
                                                                                class=" btn btn-success {{ $cart->qty < 2 ? 'disabled' : '' }}"><i
                                                                        ...
                                                                        <form action="{{ route('cartplus') }}"
                                                                            ...
                                                                            <input type="text" name="cart_id"
                                                                                value="{{ $cart->id }}" hidden>
                                                                            <button type="submit"
                                                                                class=" btn btn-success {{ $cart->qty > 9 ? 'disabled' : '' }}"><i
                                    ...
                                    <div class="tpproduct p-relative">
                                        <div class="tpproduct__thumb p-relative text-center">
                                            <a href="{{ route('product', $related->id) }}"><img
                                                src="{{ $related->img  }}" alt="" height="140"></a>
                                        <a class="tpproduct__thumb-img"
                                            href="{{ route('product', $related->id) }}"><img
                                                src="{{ $related->img  }}" alt="" height="160"></a>
                                            <div class="tpproduct__info bage">
                                        ...
                                        <div class="tpproduct__content">
                                            <span class="bg-success rounded-2 px-1 text-white">
                                                {{ $related->country }}
                                            </span>
